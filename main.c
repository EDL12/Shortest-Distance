...
int main() {
    element arr[5] = {
        {"E1", "Lib1", "Pkg1", "Val1", "0", "0", "0"},
        {"E2", "Lib2", "Pkg2", "Val2", "5", "0", "0"},
        {"E3", "Lib3", "Pkg3", "Val3", "10", "0", "0"},
        {"E4", "Lib4", "Pkg4", "Val4", "15", "0", "0"},
        {"E5", "Lib5", "Pkg5", "Val5", "20", "0", "0"}
    };
    element *arr_ptr[5] = {&arr[0], &arr[1], &arr[2], &arr[3], &arr[4]};
    shortest_distance(arr_ptr, 5);
    for (int i = 0; i < 5; i++) {
        printf("%s, ", arr[i].name);
    }
}
